...
import 'captura_i_c_c_step_model.dart';
export 'captura_i_c_c_step_model.dart';

class CapturaICCStepWidget extends StatefulWidget {
  const CapturaICCStepWidget({Key? key}) : super(key: key);

  @override
  _CapturaICCStepWidgetState createState() => _CapturaICCStepWidgetState();
}

class _CapturaICCStepWidgetState extends State<CapturaICCStepWidget> {
  late CapturaICCStepModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CapturaICCStepModel());
  }
